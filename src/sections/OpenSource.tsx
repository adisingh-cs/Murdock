...
const OpenSource: React.FC = () => (
  <section id="open-source" className="bg-parchment py-24 md:py-32">
    <div className="mx-auto max-w-[1200px] px-6 md:px-12">
      <motion.span {...reveal} className="font-body font-medium text-[13px] uppercase tracking-[0.12em] text-gold block mb-3">Open Source</motion.span>
      <motion.h2 {...reveal} className="font-display font-bold text-[30px] md:text-[42px] text-navy mb-4">Built in Public. Owned by Everyone.</motion.h2>
      ...
      <motion.div {...reveal} className="bg-white border border-warm-gray rounded-2xl p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 max-w-[780px]">
        ...
        <a href="https://github.com/adisingh-cs" target="_blank" rel="noopener noreferrer" className="shrink-0 px-5 py-2.5 rounded-lg bg-navy text-white font-body font-medium text-[14px] hover:bg-deep-blue transition-colors">View GitHub →</a>
      </motion.div>
    </div>
  </section>
);
