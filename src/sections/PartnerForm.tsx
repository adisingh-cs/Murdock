...
const inputStyle = { background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.18)' };
    ...
    <section id="partner-form" className="bg-navy py-24 md:py-32">
      <div className="mx-auto max-w-[1200px] px-6 md:px-12">
        ...
        <motion.h2 {...reveal} className="font-display font-bold text-[30px] md:text-[42px] text-white mb-4">
          Let's Build India's Legal Future Together.
        </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          {intents.map((c, i) => (
            <motion.div key={c.title} {...reveal} transition={{ ...reveal.transition, delay: i * 0.1 }} className="glass-dark p-6 text-center">
        ...
        <AnimatePresence mode="wait">
          {!submitted ? (
            ...
            >
              ...
              <motion.button
                type="submit"
                className="w-full bg-gold text-navy font-body font-bold text-[17px] py-4 rounded-[10px]"
                whileHover={{ scale: 1.02, backgroundColor: '#E8B96A' }}
                whileTap={{ scale: 0.98 }}
              >
                Send Message →
              </motion.button>
            ...
            >
              ...
              <h3 className="font-display font-bold text-[32px] text-white mb-3">
                Thank you{name ? `, ${name}` : ''}.
              </h3>
              <p className="font-body text-[17px] mb-8" style={{ color: 'rgba(255,255,255,0.72)' }}>
                I'll be in touch soon. In the meantime, you can reach me directly on any of these channels:
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {socialLinks.map(s => (
                  <a
                    ...
                    className="glass-dark p-4 rounded-xl flex items-center gap-3 hover:border-gold transition-colors"
                  >
